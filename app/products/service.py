...
class ProductService:
    ...
    no_category:str = "Category doesn't exit"
    no_brand:str = "Brand doesn't exit"
    # CREATE
    # ----------------------
    ...
    def get_product(self, item_id: int, session: SessionDep):
        statement = (
            ...
            .options(selectinload(Product.category),selectinload(Product.brand))  # Cargar la categoría
    ...
    def get_products(self, session: SessionDep):
        statement = select(Product).options(selectinload(Product.category),selectinload(Product.brand))  # Cargar categorías
